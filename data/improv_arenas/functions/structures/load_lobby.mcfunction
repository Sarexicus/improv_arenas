#load saved terrain
setblock ~-7 ~-2 ~-5 minecraft:structure_block[mode=load]{name:"improv_arenas:pvp_system_new",ignoreEntities:1b,author:"Sarexicus",posX:0,posY:1,posZ:0,rotation:"NONE",mirror:"NONE",mode:"LOAD"} replace
