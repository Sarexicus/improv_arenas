...
tag @a remove ia_spentpoint

scoreboard objectives remove iarena_echest 
scoreboard objectives add iarena_echest minecraft.custom:minecraft.open_enderchest

# add move stats
function improv_arenas:load/load_move_stats

# teams
function improv_arenas:load/load_teams
